...
<div class="new_control_form_now"><br><br>
     ...
     <form name="f_introLink3" method="post" >

     <center><br><br><br><br><br><br><br>
 
     <table border="none" style="border:none;border-collapse:separate;border-spacing:1em;" >
         <tr>
             <th style="border:none"><font color="red" align="center" family:"Arial Black" size="4">CONTROL TESTING WORKFLOW.</th>
         </tr>
    
         <tr>
             <td style="border:none" align='justify'><img src="http://localhost:8012/Project/MyCode/images/workflow.png" height="400px" width="950px"></td>
         </tr>
     </table>
